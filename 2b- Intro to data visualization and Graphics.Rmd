...
mammals <- mammals <- read.csv("~/Dropbox/Stats - 2020/R for data science/data/mammals.csv",na.strings="",stringsAsFactors =FALSE)
#or
mammals <- read_csv("~/Dropbox/Stats - 2020/R for data science/data/mammals.csv",na = c(""))
...
```{r}
x<- read.csv("~/Dropbox/Stats - 2020/R for data science/data/fruitflies.csv",na.strings="",stringsAsFactors =FALSE)
head(x)
```
